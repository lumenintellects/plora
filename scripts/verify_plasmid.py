...
def main():
    parser = argparse.ArgumentParser(description="Verify manifest SHA and RSA signature.")
    ...
    ok = verify_sha256_hex(args.public_key, manifest.artifacts.sha256, manifest.signer.signature_b64)
    if not ok:
