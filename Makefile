...
monolithic-r4:
	poetry run python -m scripts.monolithic_train --domains arithmetic,legal,medical --epochs 1 --samples $$(poetry run python -m plora.config samples) --rank 4 --output out/monolithic_r4
